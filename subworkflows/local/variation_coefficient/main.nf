//
// Merge multiple datasets and computate variation coefficient
//
...
workflow ALIGN_STAR {
    ...
    take:
    renamed_files               // channel: files containing counts with renamed gene IDs
    gene_metadata               // channel: files containing metadata (name and description) for each gene
    gene_id_mappings            // channel: files containing mapping from original to new gene IDs
